...
const I18N = {
  zh: {
    ...
    'widget.vectorizer': '位图转矢量工具 (VectorCraft)',
    'widget.vectorizer.desc': '100% 本地 WebAssembly 驱动的位图转 SVG 矢量图工具，支持高精度几何拟合与降噪。',
  ...
  en: {
    ...
    'widget.vectorizer': 'Bitmap to Vector Converter',
    'widget.vectorizer.desc': '100% local WebAssembly-powered raster image to SVG vector converter with high-precision curve fitting and noise reduction.',
